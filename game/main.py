...
def move_tiles(window, tiles, clock, direction):
    ...
    if direction == "left":
        ...
        move_check = (
            lambda tile, next_tile: tile.x > next_tile.x + GRID_WIDTH + MOVE_VEL
        )
        ceil = True
        ...
        merge_check = lambda tile, next_tile: tile.x < next_tile.x - MOVE_VEL
        move_check = (
            lambda tile, next_tile: tile.x + GRID_WIDTH + MOVE_VEL < next_tile.x
        )
        ceil = False
    elif direction == "up":
        ...
        move_check = (
            lambda tile, next_tile: tile.y > next_tile.y + GRID_HEIGHT + MOVE_VEL
        )
        ceil = True
    elif direction == "down":
        sort_func = lambda x: x.row
        ...
        merge_check = lambda tile, next_tile: tile.y < next_tile.y - MOVE_VEL
        move_check = (
            lambda tile, next_tile: tile.y + GRID_HEIGHT + MOVE_VEL < next_tile.y
        )
        ceil = False
